...
return new class extends Migration
{
    ...
    {
        Schema::create('cash_payment_voucher_lines', function (Blueprint $table) {
            $table->id();
            $table->foreignId('cash_payment_voucher_id')
                ->constrained()
                ->cascadeOnUpdate()
                ->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('cash_payment_voucher_lines');
    }
};
