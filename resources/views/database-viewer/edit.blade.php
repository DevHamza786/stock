            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Table: {{ $tableName }} | ID: {{ $id }}</p>
                    </div>
                ...
                <!-- Edit Form -->
                <form method="POST" action="{{ route('database-viewer.table.update', [$tableName, $id]) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="space-y-2">
                                ...
                                @if($column->pk)
                                    ...
                                    <input
                                        ...
                                        readonly
                                    >
                                    <p class="text-xs text-gray-500">Primary key cannot be modified</p>
