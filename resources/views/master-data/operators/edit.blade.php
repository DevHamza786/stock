        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('master-data.operators.update', $operator) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="employee_id" name="employee_id" value="{{ old('employee_id', $operator->employee_id) }}"
                            ...
                            <div>
                                ...
                                <input type="tel" id="phone" name="phone" value="{{ old('phone', $operator->phone) }}"
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email', $operator->email) }}"
