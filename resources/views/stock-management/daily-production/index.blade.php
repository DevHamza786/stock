            ...
            <div class="mb-8">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('stock-management.daily-production.create-excel') }}" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg flex items-center transition-colors duration-200">
                    ...
                    <div class="mb-6 p-4 bg-white rounded-lg border border-gray-200">
                        <form method="GET" action="{{ route('stock-management.daily-production.index') }}">
                            ...
                            <div class="flex space-x-4">
                                ...
                                @if(request()->hasAny(['product_id', 'vendor_id', 'machine_name', 'condition_status']))
