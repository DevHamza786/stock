                    ...
                    <form method="POST" action="{{ route('stock-management.gate-pass.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="client_name" name="client_name" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent @error('client_name') border-red-500 @enderror" value="{{ old('client_name') }}" placeholder="Enter client name">
                                @error('client_name')
                            ...
                            <div>
                                ...
                                <input type="text" id="client_number" name="client_number" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent @error('client_number') border-red-500 @enderror" value="{{ old('client_number') }}" placeholder="Enter client number">
                                @error('client_number')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function addItem() {
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="hidden" class="stock-addition-id" name="items[${itemIndex}][stock_addition_id]" required>
                ...
                initializeItemEvents(itemIndex);
                updateRemoveButtons();
            }
            ...
            function initializeItemEvents(itemIndex) {
