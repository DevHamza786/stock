                        ...
                        <div class="p-6">
                            <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $gatePass->stockIssued->stockAddition->product->name }}</dd>
                                </div>
                                <div>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-orange-600">{{ number_format($gatePass->quantity_issued) }}</div>
                                    <div class="text-sm text-gray-500">Pieces Dispatched</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-blue-600">{{ number_format($gatePass->sqft_issued, 2) }}</div>
                                    <div class="text-sm text-gray-500">Sqft Dispatched</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-green-600">{{ number_format($gatePass->sqft_issued / $gatePass->quantity_issued, 2) }}</div>
